...
//      Allow certain routes
                .authorizeRequests().antMatchers("/validate/key","/api/generate/**","/admin/login","/verify", "/api/auth/**", "/api/auth/agent", "/api/forgot_password", "/confirm", "/set_password","/js/**","/css/**","/admin/forgotPassword"
                		,"/admin/confirmReset","/admin/resetPassword").permitAll().
